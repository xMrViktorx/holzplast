            ...
            <div class="hidden lg:flex flex-col justify-between mt-6" id="mobile-menu">
                <aside>
                    <ul>
                        ...
                        <li>
                            <a class="flex items-center px-4 py-2 mt-5 text-gray-600 rounded-lg {{ $currentUrl == 'product' ? 'bg-white shadow-md' : 'bg-gray-100' }}" href="{{ route('admin.product.index') }}">
                                <i class="ri-dropbox-line text-2xl"></i>
                                <span class="mx-4 font-medium">Termékek</span>
                            </a>
                        </li>
                        <li>
                            <a class="flex items-center px-4 py-2 mt-5 text-gray-600 rounded-lg {{ $currentUrl == 'order' ? 'bg-white shadow-md' : 'bg-gray-100' }}" href="{{ route('admin.order.index') }}">
                                <i class="ri-list-ordered text-2xl"></i>
                                <span class="mx-4 font-medium">Rendelések</span>
                            </a>
                        </li>
                        <li>
